...
% PSO姣忎釜瀛愮�嶇兢婕斿寲涓€浠ｏ紝鍖呮嫭瀛愮�嶇兢绉诲姩锛屽�氭牱鎬х淮鎸侊紝瀛愮�嶇兢鏀舵暃鍒ゆ柇
%% Sub-swarm movement
for ii=1 : Optimizer.SwarmNumber
    ...
    %% Diff Evo
    NewPops = Optimizer.pop(ii).X(RandomPicks(:, 1), :) + 0.5 * (Optimizer.pop(ii).X(RandomPicks(:, 2), :) - Optimizer.pop(ii).X(RandomPicks(:, 3), :));
    %% Prevent Overflow
    for jj=1 : Optimizer.PopulationSize
...
%     end
% end
% if IsAllConverged == Optimizer.SwarmNumber%閲嶆柊鍒濆�嬪寲瀛愮�嶇兢
